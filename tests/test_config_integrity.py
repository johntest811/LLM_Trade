...
class ConfigIntegrityTests(unittest.TestCase):
    def test_requested_protection_profile_is_the_default_contract(self):
        ...
        self.assertEqual(settings.profit_lock_final_trigger_r, 0.60)
        self.assertEqual(settings.profit_lock_final_floor_usd, 1.00)
        self.assertEqual(settings.profit_lock_final_max_floor_r, 0.55)
        self.assertFalse(settings.profit_lock_final_fallback_only)
        self.assertTrue(settings.profit_retention_enabled)
        self.assertEqual(settings.profit_retention_trigger_usd, 1.50)
        self.assertEqual(settings.profit_retention_trigger_r, 1.00)
        self.assertEqual(settings.profit_retention_keep_fraction, 0.65)
        self.assertEqual(settings.profit_retention_mature_trigger_r, 2.00)
        self.assertEqual(settings.profit_retention_mature_keep_fraction, 0.75)
        self.assertEqual(settings.profit_retention_min_headroom_usd, 0.20)
        self.assertEqual(settings.profit_lock_mature_trigger_r, 1.25)
        self.assertEqual(settings.profit_lock_mature_floor_r, 0.70)
        self.assertEqual(settings.breakeven_trigger_r, 0.75)
        self.assertEqual(settings.trailing_trigger_r, 1.00)
        self.assertEqual(settings.trailing_distance_r, 1.00)
        ...
        self.assertEqual(settings.same_thesis_profit_reentry_min_bars, 1)
